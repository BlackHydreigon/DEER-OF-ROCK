    ...
    <div class="item">
        ...
        <div class="item-text">
         ...
         <p>esta sera la barra que mostrara tu cantidad de salud durante el juego,
             cada espacio ocupa un 12.5 de vida.
         </p>
     ...
     <div class="item">
        ...
        <div class="item-text">
         ...
         <p>esta sera una barra que te indica el estado de tu armadura, cuando esta completamente llena,
             significa que tu armadura esta perfecta, cada que se pierde una barrita, tu armadura empieza a deteriorarse
             protegiendote menos
         </p>
     ...
     <div class="item">
        ...
        <div class="item-text">
         ...
         <p>esta pocion consumible te dara un plus de proteccion, basicamente
             genera un pequeño campo protector en tu armadura.
         </p>
     ...
     <div class="item">
        ...
        <div class="item-text">
         ...
         <p>este objeto estara presente como una manera de mejorar tus armas
             añadiendoles encantamientos como por ejemplo un aumento de daño,
             crear una onda expansiva que aleje a los enemigos, etc.
         </p>
